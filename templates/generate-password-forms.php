...
<div class="wrap">
    <h1 style="position: sticky;top: 31px;background: #f1f1f1;padding: 13px 0;">
        <a href="<?php echo admin_url(); ?>admin.php?page=protected-page" title="Back to choose page"
           style="margin-right: 15px;"><?php if (is_rtl()): ?>
        ...
        <a
                target="_blank"
                href="/?p=<?php echo esc_html($_GET['page_id']); ?>">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    />
                    <a href="#" onClick="javascript: generatePassword();"
                       class="button delete"><?php echo __('Generate', 'protected-page'); ?></a
                </td>
    ...
    <table id='passwords-table' class="wp-list-table widefat fixed striped posts password-list"
           style="width: 1650px;">
        <thead>
        <tr>
            <th style="width: 30px;">
            ...
            <tr>
                <form method="post"
                    ...
                    <td class="acction-buttons">
                        ...
                        <button type="submit"
                                name="action"
                                value="<?php echo __('update', 'protected-page'); ?>"
                                class="button update button-primary">
                            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        ...
                        <button type="submit"
                                name="action"
                                value="<?php echo __('remove', 'protected-page'); ?>"
                                class="button delete" style="margin-left: 10px;">
                            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
